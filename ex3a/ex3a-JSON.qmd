...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" url="file://\\DGRLGM71\C$\Essential GIS\Data\Iowa-Statewide data\Counties" mimeType="" size="" description="" name="Shapefile" type="Local Area Network"/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial maxz="0" maxx="736849.21039300004485995" miny="4470598.39718599990010262" crs="EPSG:4326" dimensions="2" minz="0" minx="202073.80872299999464303" maxy="4822673.78653900045901537"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
